...
/**
 * Dialog class that displays Jury charts
 * 
 * @author susmab
 */
public class JuryChartDialog {
   ...
   */
  public JuryChartDialog(Symphonie owner) {
   ...
   *          The source model
   */
  public void setChart(JuryModel model, int step) {
    panel.removeAll();
