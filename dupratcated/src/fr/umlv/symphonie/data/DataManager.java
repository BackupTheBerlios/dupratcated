...
/**
 * Interface which set the standard methods for interacting with all kind of
 * data implementation in Symphonie. Some return types of some methods may sound
 * complicated, but they are crucial to the design of the application, which is
 * elaborated in order to share the same data-structure between all views.
 * 
 * @author susmab
 * 
 */
public interface DataManager {
   ...
   * 
   * @return a <code>Map</code> of <code>Student</code>s, keyed by their
   *         id.
   ...
   * 
   * @param c
   *          The <code>Course</code> to get formulas.
  ...
  /**
   * Used to get all tests related to a given course. (the <code>Mark</code>
   * class represents a test).
   * 
   * @param c
   *          The <code>Course</code> of which the tests are requested.
  ...
  /**
   * For the student view. Used to get all marks for a given course and an given
   * student. (the <code>StudentMark</code> class represents a mark).
   * 
   * @param s
   *          the <code>Student</code> for which the marks are requested.
   * @param c
   *          the <code>Course</code> for which the student's marks are
   *          requested.
   * @return a <code>Map</code> of <code>StudentMark</code>, keyed by the
   *         tests' id they are associated to.
   * @throws DataManagerException
   */
  ...
  /**
   * For the student view. Used to get all marks for a given student. (the
   * <code>StudentMark</code> class represents a mark).
   * 
   * @param s
   *          the <code>Student</code> for which the marks are requested.
   * @return a <code>Map</code> keyed with all courses, and for each one is
   *         associated a <code>Map</code> of <code>StudentMark</code>,
   *         keyed with tests' ids.
   * @throws DataManagerException
   */
  ...
  /**
   * For the teacher view. Used to get all marks for all students, for a given
   * course. The result is a pair of data, in order to keep a <code>Map</code>
   * of all tests for the course, which are all related to the marks. It is
   * useful for the <code>TeacherModel</code>.
   * 
   * @param c
   *          the <code>Course</code> of which the marks are requested.
   * @return a <code>Pair</code>. The first part is a <code>Map</code> of
   *         all tests for the course, keyed by their id. The second part is a
   *         <code>Map</code> keyed with all students. For each student is
   *         associated a <code>Map</code> of all their marks for the given
   *         course, keyed with the id of the test they are related to.
   * @throws DataManagerException
   */
  ...
  /**
   * For the jury view. Used to get all marks for all students, in all courses
   * available in the database. The result is a pair of data, in order to keep a
   * <code>Map</code> of all courses available. It is useful for the
   * <code>JuryModel</code>.
   * 
   * @return a <code>Pair</code>. The first part is a <code>Map</code> of
   *         all courses in the database, keyed with their id. The second part
   *         is a <code>SortedMap</code> keyed with all students. For each
   *         student is associated a <code>Map</code> of their marks, keyed by
   *         each course.
   * @throws DataManagerException
   */
  ...
  /**
   * For the admin Adds a new student in the database, given a name and
   * lastname.
   * 
   * @param name
   *          the name of the new student.
   * @param lastName
   *          the last name of the new student.
  ...
  /**
   * For the admin. Adds new students in the database.
   * 
   * @param namesList
   *          a list of <code>Pair<String, String></code>. The first element
   *          is the name of a new student, the second one his last name.
   * @throws DataManagerException
   */
  ...
  /**
   * For the admin. Removes a given student from the database.
   * 
   * @param s
   *          the <code>Student</code> to remove.
   * @throws DataManagerException
   */
  public void removeStudent(Student s) throws DataManagerException;

  /**
   * For the admin. Adds a new course in the database, given a title and a
   * coefficient.
   * 
   * @param title
   *          the title of the new course.
   * @param coeff
   *          the coefficient of the new course.
  ...
  /**
   * For the admin. Adds new Courses in the database.
   * 
   * @param courseList
   *          a <code>List</code> of <code>Pair<String, String></code>.
   *          The first element of each pair is the title of a new course, the
   *          second one its coefficient.
   * @throws DataManagerException
   */
  ...
  /**
   * For the admin. Removes a given course from the database.
   * 
   * @param c
  ...
  /**
   * Adds a new test in the database, given a title, coefficient and the course
   * it is related to.
   * 
   * @param desc
   *          the title of the new test to add.
   * @param coeff
   *          the coefficient of the new test to add.
   * @param c
   *          the <code>Course</code> the new test is related to.
   * @throws DataManagerException
   */
  ...
  /**
   * Adds a formula in the database, given an expression, a title, a column
   * index and the <code>Course</code> it is going to be related to.
   * 
   * @param expression
   *          the expression of the formula to add.
   * @param desc
   *          the title of the firmula to add.
   * @param course
   *          the course the formula will be associated to.
   * @param column
   *          the requested column number the formula should be located in the
   *          teacher's view.
   */
   ...
   * @param c
   *          the <code>Course</code> the formula is related to.
   * @throws DataManagerException
   */
   ...
   *          the expression of the formula to add.
   * @param desc
   *          the title of the formula to add.
   * @param column
   *          the column index where the formula should be in the jury's view.
   * @throws DataManagerException
   */
  ...
  /**
   * Changes a given student his name, last name and the comment he's related in
   * the jury's view.
   * 
   * @param s
   *          the <code>Student</code> who will be updated.
   * @param newName
   *          the new name of the student.
   * @param newLastName
   *          the new last name of the student.
   * @param newComment
   *          the new comment of the student.
   * @throws DataManagerException
   */
   ...
   *          the <code>Student</code> who will be updated.
   * @param newComment
   *          the new comment for the student.
   * @throws DataManagerException
   */
   ...
   * 
   * @param sm
   *          the <code>StudentMark</code> which will be updated.
   * @param newValue
  ...
  /**
   * Changes a given test its description and coefficient. (the class
   * <code>Mark</code> represents a test).
   * 
   * @param m
   *          the <code>Mark</code> which will be updated.
   * @param newDescription
   *          the new title for the test.
   * @param newCoeff
   *          the new coefficient for the test.
   * @throws DataManagerException
   */
  ...
  /**
   * Changes a given test its coeff. (the class <code>Mark</code> represents a
   * test).
   * 
   * @param m
   *          the <code>Mark</code> which will be updated.
   * @param newCoeff
   *          the new coeff for the test.
   * @throws DataManagerException
   */
  ...
  /**
   * Changes a test's title. (the class <code>Mark</code> represents a test).
   * 
   * @param m
   *          the <code>Mark</code> which will be updated.
   * @param newDescription
   ...
   * 
   * @param c
   *          the <code>Course</code> which will be updated.
   * @param newTitle
   *          the new title for the course.
   * @param newCoeff
   *          the new coeff for the course.
   * @throws DataManagerException
   */
   ...
   *          the <code>Course</code> which will be updated.
   * @param newCoeff
   *          the new coefficient for the course.
   * @throws DataManagerException
   */
